...
TButton btn[] = {
    {"show", {30,80, 180,80, 180,140, 30,140}, FALSE},
    {"remove", {30,280, 180,280, 180,340, 30,340}, FALSE},
    {"exit", {30,480, 180,480, 180,540, 30,540}, FALSE}
    };
...
void TButton_Show(TButton btn)
{
 ...
 glScalef(3,3,2);
 print_string(8,8, btn.name, 0,0,0);
 glPopMatrix();
}
